...
const DocumentRepositoryTab = () => {
  ...
  const loadMoreData = () => {
    if (loadMoreLoading || currentPage >= totalPage || friendFoldersLoading) return;
  ...
  const handleFolderClick = (folder) => {
    ...
    navigate(`/account-executive/detail/${id}/folder/${folder.id}`);
  };
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-none">
        <div className="flex items-center gap-2">
          <Text className="text-white font-bold">Folders</Text>
