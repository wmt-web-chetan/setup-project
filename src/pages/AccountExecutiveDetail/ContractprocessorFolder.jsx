...
const ContractprocessorFolder = () => {
  ...
  // Set container height based on screen size - Same pattern as ContractProcessorDetails
  useEffect(() => {
    const handleResize = () => {
      setContainerHeight(
  ...
  const HandleNavigate = () => {
    navigate(`/account-executive/detail/${params.id}`);
  };
  ...
  return (
    <Row className="bg-darkGray h-full w-full flex flex-col gap-3 sm:gap-6 px-header-wrapper">
      ...
      >
        {/* Left Side - Same structure as ContractProcessorDetails */}
        ...
        {/* Right Side - Same structure as ContractProcessorDetails */}
          ...
          <div className="w-full">
            ...
            >
              <div className="flex items-center text-lg font-semibold mb-6">
                ...
                <Text className="ml-3 text-white">Folder Contents</Text>
              </div>
              
              {/* Content area - NestedFolder component */}
...
export default ContractprocessorFolder;