    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-none">
        <div className="flex items-center gap-2">
          <Text className="text-white font-bold">Files</Text>
          ...
          <Col xs={24} md={24} lg={24} xl={12} className="">
            <div className="w-full flex gap-3 mt-3 md:mt-0 justify-end">
              <Button
                ...
                onClick={() => navigate(`/account-executive/detail/${id}/recently-deleted`)}
              >
                Recently Deleted
              </Button>
              <Button
            ...
            {files.map((file) => (
              ...
              >
                ...
                <div className="flex justify-between mt-3 items-center">
                  <Text 
                    className="text-sm font-semibold line-clamp-2 flex-1 mr-2"
          ...
          <Row gutter={16} className="">
            <div className="w-full pt-5 flex items-center justify-center pb-5">
              <Text className="text-base font-normal text-grayText text-center">
                Are you sure you want to delete "{selectedFile?.file_name}" file? It will be moved to the Recently Deleted section.
              </Text>
            </div>
