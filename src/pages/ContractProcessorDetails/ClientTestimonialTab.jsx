                    ...
                    <Row align="middle" gutter={[0, 0]}>
                      ...
                      {ctc && (
                        <Col className="xl:ml-4">
                          <Tag className="bg-[#FFAA1633] border-none rounded-full text-yellow-400 text-xs p-1 px-3 font-bold">
                            {ctc}
                          </Tag>
                        </Col>
                      )}
                      {loan_category && (
                        <Col>
                          <Tag className="text-[#5A76FF] bg-[#5A76FF33] border-none rounded-full text-xs p-1 px-3">
                            {loan_category}
                          </Tag>
                        </Col>
                      )}
...
const ClientTestimonialTab = () => {
  ...
  const { id } = useParams();
  const { reviewList, reviewListLoading, reviewListError } = useSelector(
    (state) => state.reviews
  );
  ...
  const { loanType, loanTypeLoading } = useSelector(
    (state) => state.contractProcessor
  );
  ...
  return (
    <div className="mt-3">
      ...
      <div className="flex items-center gap-2">
        <Text className="text-2xl font-normal">Reviews</Text>
