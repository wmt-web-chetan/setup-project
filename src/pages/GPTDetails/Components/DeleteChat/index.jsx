...
import { deleteGPTHistory } from '../../../../services/Store/GPT/slice';
import { removeChatConversationGPT } from '../../../../services/Store/GPT/action';
...
const DeleteChat = ({ openDeleteModal, setOpenDeleteModal, deleteChatData, setDeleteChatData }) => {
    ...
    const handleConfirmDelete = () => {
        ...
        dispatch(removeChatConversationGPT(payload)).then((res) => {
            ...
            if (res?.payload?.meta?.status === 200) {
                ...
                dispatch(deleteGPTHistory(res?.payload?.data))
