...
import { updateGPTHistory } from '../../../../services/Store/GPT/slice';
import { renameConversationActionGPT } from '../../../../services/Store/GPT/action';
...
const RenameChat = ({ openRenameModal, setOpenRenameModal, renameChatData, setRenameChatData }) => {
    ...
    const { chatHistory, chatHistoryLoading, recommendationLoading } = useSelector((state) => state?.gpt);
    ...
    const handleModalSubmit = () => {
        form.validateFields().then((values) => {
            ...
            dispatch(renameConversationActionGPT(payload)).then((res) => {
                ...
                if (res?.payload?.meta?.status === 200) {
                    ...
                    dispatch(updateGPTHistory(res?.payload?.data))
