...
const MyConnectionTab1 = ({ containerHeight }) => {
  ...
  const connections =
    contractProcessorRequestsForMyConnection?.data?.users || [];
  const pagination =
  ...
  const showLoading =
    contractProcessorRequestsLoadingForMyConnection || isSearching;
        ...
        {showLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4  gap-4 pb-3">
            {connections.map((user, index) => (
              <div
                key={user.id}
                onClick={() =>
                  navigate(`/account-executive/detail/${user.id}`)
                }
              >
                  ...
                  <div className="flex justify-center  flex-col relative">
                    <div className="absolute top-0 right-0 3xl:right-6">
                      <Button
                        ...
                        loading={
                          toggleLikeLoading && toggleLikeUserId === user.id
                        }
                      />
                    </div>
          ...
          <div className="flex justify-center items-center h-full">
            <Empty
              ...
              description={
                <span className="text-grayText">No connections found</span>
              }
            />
          </div>
        )}
...
export default MyConnectionTab1;
