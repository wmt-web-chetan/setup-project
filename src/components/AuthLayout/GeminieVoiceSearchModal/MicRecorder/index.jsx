...
const MicRecorder = forwardRef(({ setOpenVoiceModal, onRecordingComplete, from, handleSend, setUserQuestion }, ref) => {
  ...
  const cleanupResources = () => {
    ...
    if (canvasRef.current) {
      ...
      for (let i = 0; i < lineCount; i++) {
        ...
        drawRoundedRect(ctx, x, centerY - initialHeight, lineWidth, initialHeight, radius);
  ...
  const drawWaveform = () => {
    ...
    for (let i = 0; i < lineCount; i++) {
      ...
      drawRoundedRect(ctx, x, centerY - lineHeight, lineWidth, lineHeight, radius);
  ...
  // Stop recording WITHOUT sending (for modal close)
        ...
        <Row align={'middle'}>
          ...
          <Col xs={8} className="flex justify-end items-center">
            ...
            <Button
              ...
              disabled={transcript.final?.length <= 0}
